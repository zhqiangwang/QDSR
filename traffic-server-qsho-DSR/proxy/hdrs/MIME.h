...
extern const char *MIME_FIELD_QUIC_CONNECTION_ID;
extern const char *MIME_FIELD_QUIC_STREAM_ID;
extern const char *MIME_FIELD_QUIC_PACKET_NUMBER;
extern const char *MIME_FIELD_QUIC_WORKER_ID;
extern const char *MIME_FIELD_QUIC_FIVE_TUPLE;
extern const char *MIME_FIELD_QSHO_SECRET;
...
extern int MIME_LEN_QUIC_CONNECTION_ID;
extern int MIME_LEN_QUIC_STREAM_ID;
extern int MIME_LEN_QUIC_PACKET_NUMBER;
extern int MIME_LEN_QUIC_WORKER_ID;
extern int MIME_LEN_QUIC_FIVE_TUPLE;
extern int MIME_LEN_QSHO_SECRET;
...
extern int MIME_WKSIDX_QUIC_CONNECTION_ID;
extern int MIME_WKSIDX_QUIC_STREAM_ID;
extern int MIME_WKSIDX_QUIC_PACKET_NUMBER;
extern int MIME_WKSIDX_QUIC_WORKER_ID;
extern int MIME_WKSIDX_QUIC_FIVE_TUPLE;
extern int MIME_WKSIDX_QSHO_SECRET;
...
inline void
MIMEHdr::set_timestamp1(int64_t value)
{
  value_set_int64(MIME_FIELD_QUIC_STREAM_ID, MIME_LEN_QUIC_STREAM_ID, value);
}

inline void
MIMEHdr::set_timestamp2(int64_t value)
{
  value_set_int64(MIME_FIELD_QUIC_WORKER_ID, MIME_LEN_QUIC_WORKER_ID, value);
}
...
inline uint32_t
hex_to_bytes(unsigned char *dst, const char *src, uint32_t len)
{
  if (len % 2 != 0) {
    return -1;
  }
