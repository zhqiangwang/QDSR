...
#define VC_EVENT_B2F_MSG (VC_EVENT_EVENTS_START + 8)

#define VC_EVENT_QSHO_RESCHEDULE (VC_EVENT_EVENTS_START + 9)

#define VC_EVENT_QSHO_WRITE_FINISHED (VC_EVENT_EVENTS_START + 10)

#define VC_EVENT_QSHO_UPDATE_LARGEST_ACK (VC_EVENT_EVENTS_START + 11)

#define VC_EVENT_QSHO_WRITE_POLL (VC_EVENT_EVENTS_START + 12)

#define VC_EVENT_QSHO_ACK_FINISHED (VC_EVENT_EVENTS_START + 13)

#define VC_EVENT_QSHO_STREAM_CLOSE (VC_EVENT_EVENTS_START +14)
//
// Event names
//
