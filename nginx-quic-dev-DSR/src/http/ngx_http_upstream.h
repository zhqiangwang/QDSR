...
struct ngx_http_upstream_s {
    ...
    ngx_buf_t                        buffer;
    off_t                            length;
    ngx_buf_t                       *qsho_send_buf;
    ngx_buf_t                       *qsho_ack_buf;
    ngx_event_t                      wait_ev;

    ngx_chain_t                     *out_bufs;
    ngx_chain_t                     *busy_bufs;
    ngx_chain_t                     *free_bufs;
    ngx_chain_t                     *qsho_out_bufs;
    ...
    unsigned                         handoff:1;
    unsigned                         upstream_handoff:1;
    unsigned                         qsho_finished:1;
    unsigned                         dsr_inited:1;
};
...
ngx_int_t qsho_parse_request(ngx_http_request_t *r,
        ngx_buf_t *b);
void
qsho_upstream_finalize_request(ngx_http_request_t *r, ngx_http_upstream_t *u);
void qsho_upstream_write_handler(ngx_http_request_t *r,
        ngx_http_upstream_t *u);
void dsr_init(ngx_http_request_t *r, ngx_http_upstream_t *u);
