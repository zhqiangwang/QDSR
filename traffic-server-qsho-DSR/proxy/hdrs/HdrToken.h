...
#define MIME_SLOTID_QUIC_PACKET_NUMBER 29
#define MIME_SLOTID_QUIC_FIVE_TUPLE 30
#define MIME_SLOTID_QSHO_SECRET 31
...
#define MIME_PRESENCE_QUIC_PACKET_NUMBER (TOK_64_CONST(1) << 56)
#define MIME_PRESENCE_QUIC_FIVE_TUPLE (TOK_64_CONST(1) << 57)
#define MIME_PRESENCE_QSHO_SECRET (TOK_64_CONST(1) << 58)
