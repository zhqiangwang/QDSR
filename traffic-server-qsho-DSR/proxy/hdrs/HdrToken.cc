...
static HdrTokenFieldInfo _hdrtoken_strs_field_initializers[] = {
  ...
  {"QUIC-Packet-Number", MIME_SLOTID_QUIC_PACKET_NUMBER, MIME_PRESENCE_QUIC_PACKET_NUMBER, (HTIF_COMMAS | HTIF_MULTVALS)},
  {"QUIC-Five_Tuple", MIME_SLOTID_QUIC_FIVE_TUPLE, MIME_PRESENCE_QUIC_FIVE_TUPLE, (HTIF_COMMAS | HTIF_MULTVALS)},
  {"Qsho-Secret", MIME_SLOTID_QSHO_SECRET, MIME_PRESENCE_QUIC_FIVE_TUPLE, (HTIF_COMMAS | HTIF_MULTVALS)},
  {nullptr, 0, 0, 0},
};
